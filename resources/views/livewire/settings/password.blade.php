<div class="max-w-xl mx-auto py-10">
    <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-6">Update Password</h1>

    <form wire:submit="updatePassword" class="space-y-6">
        <div>
            <label for="current_password"
                class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-200">Current
                Password</label>
            <div class="mt-2">
        ...
        <div>
            <label for="password" class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-200">New
                Password</label>
            <div class="mt-2">
        ...
        <div>
            <label for="password_confirmation"
                class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-200">Confirm New
                Password</label>
            <div class="mt-2">
